...
public class DeptController {
    ...
    public ResponseResult list(@Param(required = false) String name,
        ...
        return ResponseResult.success("何炳煌大王666", deptPageResult);
    }
    ...
    public ResponseResult add(@NotBlank(message = "部门名称不能为空") String name) {
        ...
        return ResponseResult.success("何炳煌大王666", null);
    }
    ...
    public ResponseResult delete(@Path int id) {
        ...
        if (count > 0) {
            return ResponseResult.failure("该部门下有关联用户，可以删除", null);
        }
    ...
    public ResponseResult get(@Path int id) {
        ...
        return ResponseResult.success("何炳煌大王666", deptEntity);
    }
